        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Edit Jenis Kayu</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <div class="col-lg-5 container"> 
            <div class="card card-dark ">
              <div class="card-header">
                <h3 class="card-title text-lg"> <b>Edit Jenis Kayu</b> </h3>
              </div>
               ...
               <div class="card-body">  
                        ...
                        <div class="row">
                            ...
                            <?php endif; ?> 
                                ...
                                <form method="post" action="<?= base_url(); ?>/jenis-kayu/e/<?=$datajeniskayu->id_jenis_kayu?>"> 
                                    <?= csrf_field(); ?>
                
 
                                    <div class="form-group">
                                        <label for="name" class="form-label">Jenis Kayu</label>
                                        <input type="text" class="form-control" id="jeniskayu" name="jeniskayu" placeholder="Silahkan Ketikan Jenis Kayu." value="<?=$datajeniskayu->nama_jenis_kayu?>">
                                    </div>
                                    <div class="form-group">
