               ...
               <div class="card-body">  
                        ...
                        <div class="row">
                            ...
                            <?php endif; ?> 
                                ...
                                <form method="post" action="<?= base_url(); ?>/tipe-kayu/e/<?=$dataTipeKayus->id_tipe_kayu ?>"> 
                                    <?= csrf_field(); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="jkayu" id="" class="form-control select2 select2-primary" data-dropdown-css-class="select2-primary" style="width: 100%;"> 
                                            ...
                                            <?php  foreach ($dataJenisKayus as $item1): ?>  
                                                <option value="<?=$item1->id_jenis_kayu?>" <?php echo ($item1->id_jenis_kayu == $dataTipeKayus->id_jenis_kayu) ? "selected" : ""?>  > <?=$item1->nama_jenis_kayu?></option>
                                            <?php endforeach; ?>  
                                        </select> 
                                    </div>
                                    <div class="form-group">
                                        <label for="name" class="form-label">Tipe Kayu</label>
                                        <input type="text" name="tkayu" class="form-control" placeholder="Silahkan Ketikan Tipe Kayu."  value="<?=$dataTipeKayus->nama_tipe_kayu?>">
                                    </div>
                                    <div class="form-group">
